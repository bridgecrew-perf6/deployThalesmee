		...
		<div class="flex-legend">
			<table style="border-spacing:2px 2px; text-align:center;">
				...
				<tr>
					...
					<td class="second"><strong style="opacity:0">-----------</strong><span class='rondOrange'></span><strong style="opacity:0">-----------</strong><p  style="padding-left:15px;" class="retourLigne font">Retard Livraison</p></td>
					<td class="second"><strong style="opacity:0">----------></strong><span class='rondRouge'></span><strong style="opacity:0">-----------</strong><p class="retourLigne font">Non planifié</p></td>
					<td class="second"><strong style="opacity:0">----------></strong><span>&#x26A0;</span><strong style="opacity:0">-----------</strong><p class="retourLigne font">Retard ME</p></td>
					<td class="second"><strong style="opacity:0">----------></strong><span class='carre carreRouge'></span><strong style="opacity:0">-----------</strong><p class="retourLigne font">Anomalie</p></td>
					<td class="second"><strong style="opacity:0">----------></strong><span class='carre bar-maintenance'></span><strong style="opacity:0">-----------</strong><p class="retourLigne font">Maintenance</p></td>
					<td class="second" style="opacity:0"><strong style="opacity:0">---------------></strong><span class='carre bar-retour'></span><strong style="opacity:0">----------></strong><p class="retourLigne font">Retour équipement</p></td>
...
echo '<script src="../js/visuEssai.js"></script>';
?>
