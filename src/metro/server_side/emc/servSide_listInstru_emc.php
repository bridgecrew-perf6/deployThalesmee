<?php
	...
	/* DB table to use */
	$sTable = "instrument_emc ie LEFT OUTER JOIN designation_emc d ON ie.idDes_designation_emc=d.idDes LEFT OUTER JOIN equipement_emc ee ON d.idEquip_equipement_emc=ee.idEquip, instrument i LEFT OUTER JOIN localisation l ON i.idLocal_localisation=l.idLocal";
	...
	if($sWhere != "")
		...
		$condWhere="where ";
	$condWhere.="i.numInstru=ie.numInstru_instrument and i.idStatut_statut!=4";
