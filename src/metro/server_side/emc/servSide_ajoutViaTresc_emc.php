<?php
	...
	$aColumns = array( 'numInstru', 'nomDes', 'nomStatut', 'numSerie', 'marque', 'modele', 'date_futureInt', 'nomLocal');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "numInstru";
	
	/* DB table to use */
	$sTable = "statut s, ajoutInstru ai, instrument i LEFT OUTER JOIN localisation l ON i.idLocal_localisation=l.idLocal
	...
	if($sWhere != "")
		...
		$condWhere="where ";
	$condWhere.="i.numInstru = ai.numInstru_instrument
	and ai.idLabo_labo=1
