<?php
	...
	$aColumns = array( "DATEDIFF(date_futureInt,CURDATE())",'date_futureInt', 'nomEquip', 'fonction','numInstru');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "numInstru";
	
	/* DB table to use */
	$sTable = "equipement_emc ee, instrument_emc ie LEFT OUTER JOIN designation_emc d ON ie.idDes_designation_emc=d.idDes, instrument i";
