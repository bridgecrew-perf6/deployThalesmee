...
$str="select idPret,nomPret,nomCorresp,nomLocal from histo_pret p LEFT JOIN localisation l ON p.idLocal_localisation=l.idLocal
						...
						<tbody>
							<?php
								while($lg=mysqli_fetch_object($req))
								{
									...
									echo "<tr style='cursor:pointer;' onclick='document.location.href=\"detailsHistoPret.php?idPret=$idPret\"'>";
										echo "<td>$idPret</td>";
										echo "<td>$nomPret</td>";
