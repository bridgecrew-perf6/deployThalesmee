...
$aColumns = array( 'noOF', 'nomModele');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "noOF";

/* DB table to use */
$sTable = "equipement_of e, type_modele m, tester t, essai es"; //etatessai et
...
if($sWhere != "")
	...
	$condWhere="where ";
$condWhere.="e.idModele_TYPE_MODELE=m.idModele
and t.idEssai_ESSAI=es.idEssai
and es.idService_service='$idServ_Labo'
