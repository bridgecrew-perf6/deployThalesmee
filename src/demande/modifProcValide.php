...
<div class="container">
	<div class="page-header">
		<h2>Modification d'une demande de procédure validée</h2>
	</div>
	...
	<div class="container theme-showcase" role="main">
		...
		<div class="jumbotron">
			<center><p style="color:red">Veuillez informer les événtuels rédacteurs de la modification de la demande</p></center>
	...
	<center>
		<form style="display:inline;" method="post" id='form' action="DProc_1.php?idDP=<?php echo $idDP; ?>" onSubmit="return rappelModif()">
			<input type="hidden" value="<?php echo $idDP; ?>" name="idDemProc" />
			<input type="submit" class="btn btn-lg btn-primary" value="Modifier la demande" id="valider" onclick="sendDP()"/>
		</form>
		<input type="button" class="btn btn-lg btn-primary"  value="Annuler" id="valider" onclick="document.location.href='listDP.php?mode=2';"/>
	</center>
</div>
<script>
	function rappelModif()
	{
		if(confirm("Veuillez à modifier la demande en intégralité afin qu'elle soit de nouveau validée"))
			return true;
		return false;
	}
</script>
