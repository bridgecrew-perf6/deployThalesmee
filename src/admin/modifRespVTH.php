...
if(isset($_POST["resp"]))
{
	...
	$str="update SERVICE set idEmp_EMPLOYE=$newId where idService=3;";
...
<div class="container">
	<div class="page-header">
        <h2>Responsable laboratoire VTH actuel : <?php echo $nomAncienRL." - ".$prenomAncienRL; ?></h2>
	</div>
	<div class="container theme-showcase" role="main">
	<h2 class="sub-header">Modification</h2>
		<div class="jumbotron">
			<form method="post" class="form-user" role="form" action="modifRespVTH.php" onsubmit="return confirmModifResp();">
	...
	function confirmModifResp()
	{
		...
		var t=document.querySelectorAll('.alert');
