...
*/
session_start();
if(isset($_SESSION["metro"]) && ($_SESSION['metro']['categUser']==1 || $_SESSION['metro']['categUser']==2)) //on verifie que l'utilisateur a le droit d'etre sur cette page
{
			...
			<div class="collapse navbar-collapse">
			  <ul class="nav navbar-nav">
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li><a href="listInstru.php">Liste des instruments</a></li>
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					...
					<li><a href="gestionType.php">Gestion des types</a></li>
					<li><a href="gestionDomaine.php">Gestion des domaines</a></li>
					<li><a href="gestionDesignation.php">Gestion des désignations</a></li>
				  </ul>
				</li>
			 </ul>
				...
				<li class="dropdown">
				 <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $prenom." ".$nom;  ?><b class="caret"></b></a>
				  ...
				  <?php
					...
					{
						echo '<li><a href="../index.php">Retour logiciel</a></li>';
					}
					?>
