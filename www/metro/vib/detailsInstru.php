...
else
{
	...
	if(isset($_GET["prov"]))
	{
		if($_GET["prov"]==1) //listCapteur
			...
			if (isset($_GET["filter"]))
				$pagePrec="listInstru.php".$filter;
			else
				$pagePrec="listInstru.php".$filter;
	...
	else
	{
		...
		<div class="text-center">
			...
			<input type="button" value="Dupliquer" class="btn btn-primary btn-lg" onclick="document.location.href='dupliqInstru.php?numInstru=<?php echo $numInstru; ?>'"/>
