...
*/
session_start();
if(isset($_SESSION["metro"]) && isset($_SESSION["metro"]["labo"])) //on verifie que l'utilisateur a le droit d'etre sur cette page
{
			...
			<div class="collapse navbar-collapse">
			 <ul class="nav navbar-nav">
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li><a href="listMetroFutCalib.php">Futures calibrations interne</a></li>
					<li><a href="listMetroCalib.php">En calibration interne</a></li>
				...
				<li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pv de test<b class="caret"></b></a>
				  <ul class="dropdown-menu">
					<li><a href="creerModifierPv.php">Créer un PV de Test</a></li>
					<li><a href="listPvTest.php">Liste des Pv</a></li>
				  </ul>
				</li>
				<li class="dropdown">
