<?php
	...
	$aColumns = array( 'numInstru', 'nomEquip', 'fonction','marque', 'modele', 'caracteristique', 'date_futureInt', 'nomStatut', 'CASE  when trescalid IS NULL then \'Interne\' ELSE \'Trescal\' END');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "numInstru";
	
	/* DB table to use */
	$sTable = "statut s, equipement_emc ee, instrument_emc ie LEFT OUTER JOIN designation_emc d ON ie.idDes_designation_emc=d.idDes, instrument i LEFT OUTER JOIN localisation l ON i.idLocal_localisation=l.idLocal";
	...
	if($sWhere != "")
		...
		$condWhere="where ";
	$condWhere.="i.numInstru=ie.numInstru_instrument and d.idEquip_equipement_emc=ee.idEquip and i.idStatut_statut=s.idStatut and i.idStatut_statut!=4 
